...
<body class="antialiased bg-gray-100 flex flex-col items-center justify-center">
    ...
    @if (Session::has('success'))
        <div id="successMessage"
            class="text-center text-green-500 font-bold text-xl bg-white shadow-lg h-20 absolute w-80 flex items-center justify-center top-4 rounded-lg">
            {{ Session::get('success') }}
        </div>
        <script>
            setTimeout(function() {
    ...
    <div class="flex flex-col items-center justify-center mx-4 font-mon my-10 w-full px-10">
        ...
        <div class='w-full  flex mx-4 flex-col h-full gap-4 items-center justify-center my-4'>
            ...
            @else
                <h1 class="text-black font-bold text-4xl">No Articles</h1>
            @endif
            ...
            @if (isset($articles))
                <div class="flex flex-row gap-4 my-10">
                    @if ($apiResponse['pages'] > 1)
                        ...
                        <a href="/?search={{ request('search') }}&page={{ $apiResponse['pages'] }}"
                            class="text-black">
                            Last
                        </a>
                    @endif
        ...
        {{-- PINNED ARTICLES --}}
        <div
            class='w-full flex items-start justify-center bg-error shadow-lg flex-col bg-white px-4 rounded-l p-4 max-w-full h-full'>
